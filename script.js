let studentRecords = [
  ...
  //Ans:-
  let obj1 = { name: "Akshat", class: "X", rollno: "37" };
  let obj2 = { name: "Vikram", class: "XI", rollno: "40" };
  let obj3 = { name: "Vishnu", class: "XII", rollno: "45" };
  let obj4 = { name: "Prashant", class: "XI", rollno: "48" };
  let obj5 = { name: "Pushpa", class: "X", rollno: "07" };
  let obj6 = { name: "Prachi", class: "XII", rollno: "18" };
  
  let students = [
    { name: "Akshat", class: "X", rollno: "37" },
    { name: "Vikram", class: "XI", rollno: "40" },
    { name: "Vishnu", class: "XII", rollno: "45" },
    { name: "Prashant", class: "XI", rollno: "48" },
    { name: "Pushpa", class: "X", rollno: "07" },
    { name: "Prachi", class: "XII", rollno: "18" },
  ];
